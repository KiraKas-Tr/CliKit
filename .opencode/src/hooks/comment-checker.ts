...
export function checkCommentDensity(content: string, threshold: number = 0.3): CommentCheckResult {
...
export function hasExcessiveAIComments(content: string): boolean {
  let matches = 0;
